            ...
            <div class="row">
               <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  ...
                  <div class="banner-block mt-0">
                      <img src="<?php echo base_url('assets/images/ba-5.jpg'); ?>" alt="banner collection">
                    ...
                    <!--  <source src="<?php echo base_url('assets/video/dawlance.mp4');?>" type="video/mp4">-->
                    <!--  Your browser does not support the video tag.-->
                    <!--</video>-->
                  </div>
                  <div class="banner-block">
                     <img src="<?php echo base_url('assets/images/ba-1.png'); ?>" alt="banner collection">
                     <div class="text-des-container pad-zero">
                        <div class="text-des">
                           <!-- <h2>Product Name</h2> -->
                           <!-- <p>Lorem Ipsum is simply dummy!</p>
               ...
               <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                  ...
                  <div class="banner-block mt-0">
                     <a href="#"> <img src="<?php echo base_url('assets/images/tcl_2_1.jpg'); ?>" alt="banner arrival"> </a>
                     <div class="text-des-container">
                        <div class="text-des">
                           <!-- <h2>Product Name</h2> -->
                           <!-- <p>Lorem Ipsum is simply dummy!</p>

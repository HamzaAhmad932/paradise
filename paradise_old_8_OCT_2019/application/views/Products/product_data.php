                           ...
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    ...
                                    <a href="<?php echo site_url('Products/Products_detail/'.$r->id); ?>"><img class="card-img-top img-fluid" src="<?php echo base_url().$r->img_path; ?>" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       ...
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="View Detail"><i class="fa fa-search"></i></a>
                                    </div>
                                    <p class="card-title"><a href="<?php echo site_url('Products/Products_detail/'.$r->id); ?>"><?php echo $r->pro_title; ?></a></p>
                                    <p>
